...
const HamburgerMenu = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <div
            className={`z-40 fixed top-0 right-0 h-fit w-90 bg-white shadow-lg transform transition-transform duration-300 md:hidden ${
        ...
        >
            <div>
                <button
                    className="absolute top-10 right-5 p-2 bg-gray-700"
            ...
            <nav
                className="h-[100dvh] flex flex-col items-center mt-30 space-y-10"
